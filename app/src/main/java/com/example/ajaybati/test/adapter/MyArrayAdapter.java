package com.example.ajaybati.test.adapter;
...
import com.example.ajaybati.test.R;
...
public class MyArrayAdapter extends ArrayAdapter<MyDataModel> {
    ...
    // Constructors
    public MyArrayAdapter(Context context,int layoutRes, List<MyDataModel> objects) {
